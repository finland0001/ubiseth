...
namespace Client
{
    ...
    class customText : TextBox
    {
        ...
        public customText()
        {
            ...
            this.ForeColor = Ubiseth.settings.Shifty;
    ...
    class rainbowPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            SolidBrush lgb = new SolidBrush(Ubiseth.settings.Shifty);
    ...
    class iTalk_TabControl : TabControl
    {
        ...
        private Color selectedTab = Color.Red;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(BackColor); //other big bg which was originally white
            ...
            _Graphics.FillRectangle(new SolidBrush(BackColor), new Rectangle(-5, 0, ItemSize.Height + 4, Height));//26, 38, 63 orig dark grey
            // Draw vertical line at the end of the tab selector rectangle
            _Graphics.DrawLine(new Pen(BackColor), ItemSize.Height - 1, 0, ItemSize.Height - 1, Height);
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
            {
                if (TabIndex == SelectedIndex)
                {
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(8, 11, 18)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3); //orig almost black (selected tab color)
                    ...
                    _Graphics.FillRectangle(new SolidBrush(SelectedTab), TabHighlighter); //side of selected tab color
                    // Draw tab text
